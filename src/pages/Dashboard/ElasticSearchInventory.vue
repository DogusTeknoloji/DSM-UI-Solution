        ...
        <div class="col-md-12 table-card" v-if="!forbidden_page">
            <table class="table table-hover table-stripped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td v-if="GET_LIST.length < 1 || GET_LIST == null" colspan="9" align="center"> <span>Record is
                                empty!</span> </td>
                    </tr>
                </tbody>
            </table>
    ...
    methods: {
        ...
        gotoLink(esi) {
            ...
            if (esi.url.includes("https://")) {
                ...
                console.log(esi.username+' '+esi.password);
                if (esi.username !== 'null' && esi.username !== 'undefined') {
                    window.open("http://" + modifiedUrl, "_blank");
                } else {
                    // Sifreler Header uzerinden yollanana kadar gecici cozum
